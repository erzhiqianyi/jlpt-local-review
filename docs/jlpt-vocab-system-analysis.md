...
练习题不要只做“看中文选日语”。这份资料适合生成 5 类题：

1. 读音回忆：看到 `測定`，输入或选择 `そくてい`。
2. 核心义回忆：看到日语，先自己想中文核心义，再翻答案。
3. 搭配填空：`血圧を＿＿する`，答案 `測定`。
4. 易混词判断：`測定・計測・測量` 放到不同语境里选。
5. JLPT 文字・語彙：模拟语言知识中的词汇选择题，例如给句子空格，在 4 个选项中选择最自然的词。
...
4. 为每个词自动生成读音、词义、搭配、易混、文字・語彙练习题。
